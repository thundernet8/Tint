  ...
  function ot_type_export_data() {
    ...
    echo '<div class="format-setting type-textarea simple has-desc">';
      ...
      echo '<div class="format-setting-inner">';
        echo '<textarea rows="6" cols="40" name="export_data" id="export_data" class="textarea">' . $data . '</textarea>';
      echo '</div>';
    ...
    echo '<form method="post" id="import-data-form">';
      ...
      echo '<div class="format-setting type-textarea has-desc">';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<textarea rows="6" cols="40" name="import_data" id="import_data" class="textarea"></textarea>';
